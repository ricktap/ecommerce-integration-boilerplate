<template>
    <div class="catalog__select">
        <select :disabled="!values.length" :value="value" @change="emit('input', $event.target.value)">
            <option :value="undefined" disabled="disabled" hidden="hidden">{{ defaultOption }}</option>
            <option v-for="el in values" :value="el.id">{{ el.name }}</option>
        </select>
    </div>
</template>
...
const { dataset: values } = toRefs(props)
