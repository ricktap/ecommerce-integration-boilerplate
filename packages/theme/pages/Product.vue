      ...
      <div class="product__info">
        ...
        <div>
          ...
          <div class="offer-selection">
            <div class="offer" v-for="offer in product.offers">
              <div style="display: flex; justify-content: space-between; align-items: center;">
                <img :src="offer.vendor.logo" :alt="offer.vendor.name" height="31px" width="65px" />
                <div class="price">
                ...
                <SfAddToCart
                  ...
                  @click="addItem({ product: offer, quantity: parseInt(qty) })"
                />
              </div>
            </div>
          </div>
...
import { useProduct, useCart, productGetters, useReview, reviewGetters } from '@vue-storefront/vsfDapPim';
